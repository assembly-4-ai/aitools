...
Q_CONSTINIT static const uint qt_meta_data_CLASSLLMServiceENDCLASS[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QStringList, QMetaType::QString,    8,    6,
...
void LLMService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->responseReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[4]))); break;
        case 1: _t->modelsFetched((*reinterpret_cast< std::add_pointer_t<QStringList>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LLMService::*)(const QString & , const QString & , const QString & , const QString & );
            if (_t _q_method = &LLMService::responseReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LLMService::*)(const QStringList & , const QString & );
            if (_t _q_method = &LLMService::modelsFetched; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LLMService::responseReady(const QString & _t1, const QString & _t2, const QString & _t3, const QString & _t4)
{
...
// SIGNAL 1
void LLMService::modelsFetched(const QStringList & _t1, const QString & _t2)
{
